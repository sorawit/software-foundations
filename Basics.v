...
Proof.
  intros b c H.
  destruct b; destruct c; simpl in *; congruence.
Qed.
(** [] *)
...
Fixpoint bin_to_nat (b : bin) : nat :=
  ...
  | bZ => 0
  | bO b' => 2 * bin_to_nat b'
  | bI b' => 1 + 2 * bin_to_nat b'
  end.

Example test_bin_incr1 : bin_to_nat (incr bZ) = S (bin_to_nat bZ).
Proof. reflexivity. Qed.
Example test_bin_incr2 : bin_to_nat (incr (bO bZ)) = S (bin_to_nat (bO bZ)).
Proof. reflexivity. Qed.
Example test_bin_incr3 : bin_to_nat (incr (bI bZ)) = S (bin_to_nat (bI bZ)).
Proof. reflexivity. Qed.
Example test_bin_incr4 : bin_to_nat (incr (bO (bI bZ))) = S (bin_to_nat (bO (bI bZ))).
Proof. reflexivity. Qed.
Example test_bin_incr5 : bin_to_nat (incr (bI (bO bZ))) = S (bin_to_nat (bI (bO bZ))).
Proof. reflexivity. Qed.
(** [] *)
...
(** $Done: 2016-03-10 13:14:38 -0500 (Thu, 10 Mar 2016) $ *)
